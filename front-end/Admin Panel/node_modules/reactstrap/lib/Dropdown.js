...
class Dropdown extends React.Component {
  constructor(props) {
    ...
    this.toggleRef = /*#__PURE__*/React.createRef();
  ...
  render() {
    ...
    if (this.context.insideInputGroup) {
      ...
      }, /*#__PURE__*/React.createElement(Manager, null, React.Children.map(this.props.children, child => /*#__PURE__*/React.cloneElement(child, {
